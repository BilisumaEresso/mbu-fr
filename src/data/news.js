...
export const news = [
  {
    ...
    fullContent: [
      "The 2024 harvest season is shaping up to be one of the most prolific in Meki Batu Union's history. Early field audits across our 136 primary member cooperatives indicate a 28% increase in overall crop yield compared to the previous fiscal year.",
  ...
  },
  {
    ...
    fullContent: [
      "The 2024 Meki Batu Union Annual General Assembly brought together over 500 delegates representing 136 primary agricultural cooperatives across East Shewa and Arsi zones.",
